...
return (
  <div className="slide-in">
    ...
    <p>
    Mindfire Solutions is a 22 years old software development & IT services company.
    It specialize in offering customized technological and digital solutions to enable.
    <br/>
    I have been a part of a health care domain project. 
    The project provided end to end solution for any hospital's digital needs.
    From patient data managment to Insurance claims and Reports, it was capable of handling it all. 
    </p>
    <div>
